...
export const FreeScript = () => {
  ...
  const copy = async () => {
    ...
    setCopied(true);
    toast({ title: "Copied to clipboard", description: "Paste it into your executor." });
  ...
  return (
    <section id="free-script" className="relative py-28 scroll-mt-24">
      <div className="container max-w-3xl text-center">
        ...
        <div className="mt-10 overflow-hidden rounded-2xl border border-border/80 bg-card/60 text-left">
